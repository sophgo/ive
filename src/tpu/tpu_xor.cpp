...
int IveTPUXOr::init(bmctx_t *ctx, bmk1880v2_context_t *bk_ctx) {
...
void IveTPUXOr::operation(bmctx_t *ctx, bmk1880v2_context_t *bk_ctx) {
  bmk1880v2_tiu_element_wise_xor_int8(bk_ctx, &m_p_or);
}